...
cmd [[
  function! KillBuf(bufnr,b,c,d)
    call luaeval('require("ui.bufferline.utils").bufferclose(_A)', a:bufnr)
  endfunction]]

cmd "function! NewTab(a,b,c,d) \n tabnew \n endfunction"
cmd "function! GotoTab(tabnr,b,c,d) \n execute a:tabnr ..'tabnext' \n endfunction"
cmd "function! TabClose(a,b,c,d) \n lua require('ui.bufferline.utils').closeallbufs('closeTab') \n endfunction"
cmd "function! CloseAllBufs(a,b,c,d) \n lua require('ui.bufferline.utils').closeallbufs() \n endfunction"
