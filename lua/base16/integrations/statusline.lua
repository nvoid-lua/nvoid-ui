...
return {
  ...
  -- Evil
  St_NormalModeE = { bg = colors.black },
  St_InsertModeE = { bg = colors.black },
  St_TerminalModeE = { bg = colors.black },
  St_NTerminalModeE = { bg = colors.black },
  St_VisualModeE = { bg = colors.black },
  St_ReplaceModeE = { bg = colors.black },
  St_ConfirmModeE = { bg = colors.black },
  St_CommandModeE = { bg = colors.black },
  St_SelectModeE = { bg = colors.black },
