...
return {
  ...
  FoldColumn = { fg = theme.base01, bg = theme.base01 },
  ...
  Substitute = { fg = theme.base01, bg = theme.base01 },
  ...
  Conceal = { bg = "NONE" },
  Cursor = { fg = theme.base01, bg = theme.base01 },
  NonText = { fg = theme.base00 },
  ...
  SpellLocal = { undercurl = true, sp = theme.base01 },
